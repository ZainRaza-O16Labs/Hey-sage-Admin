...
export function ParentAgentForm({ initial }: { initial: ParentAgentConfig | null }) {
  ...
  return <div className="space-y-5">
    ...
    <div className="flex items-center gap-3"><input id="automatic-routing" type="checkbox" checked={form.automatic_routing} onChange={(event) => setForm({ ...form, automatic_routing: event.target.checked })} className="size-4 accent-primary" /><Label htmlFor="automatic-routing">Automatic agent routing</Label></div>
